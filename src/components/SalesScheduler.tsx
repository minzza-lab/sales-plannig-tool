...
type Product = { id: string; title: string; category: Category; company_id?: string; company_name: string; sales_start: string; sales_end: string; target_amount: number; memo?: string; color: string }
