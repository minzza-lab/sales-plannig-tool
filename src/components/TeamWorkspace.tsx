...
export default function TeamWorkspace() {
  ...
  return <div className="team-workspace animate-fade-in">
    <header className="team-workspace-header"><div><p className="workspace-eyebrow"><Users size={15} /> TEAM WORKSPACE</p><h1>공유 스케줄러 · 업무 트래커</h1><p>팀 일정과 업무 진행 상황을 한곳에서 함께 관리합니다.</p></div><button className="workspace-primary" onClick={() => setComposer(view === 'calendar' ? 'event' : 'task')}><Plus size={18} /> {view === 'calendar' ? '일정 등록' : '업무 등록'}</button></header>
